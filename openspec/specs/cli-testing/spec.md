...
Defines the test project and testing approach for the Arius CLI, covering command parsing, option validation, and DI wiring without requiring Azure credentials or network access.
