...
## Purpose
Defines the RESTful API layer and SignalR hub that expose all repository operations to web clients and other consumers, dispatching through the shared Mediator pipeline.
