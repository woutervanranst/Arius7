...
## Purpose
Defines the optional local SQLite cache for fast queries against index, snapshot, and tree data, including delta sync, cache tables, and fallback behavior without cache.
