...
- [ ] 2.1 Move large and tar chunk upload protocol details into `ChunkStorageService`, including progress wiring, gzip/encryption transforms, metadata writes, tier assignment, and already-exists recovery
