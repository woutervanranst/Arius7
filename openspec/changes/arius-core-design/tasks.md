...
- [ ] 5.2 Implement chunk index read: download shard, decrypt, deserialize, lookup content hash
- [ ] 5.3 Implement chunk index write: add entries, serialize, encrypt, upload affected shards
