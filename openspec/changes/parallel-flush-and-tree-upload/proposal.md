...
- `chunk-index-service`: Chunk-index flush changes from one-prefix-at-a-time to bounded parallel shard flushing without changing shard format or repository layout.
