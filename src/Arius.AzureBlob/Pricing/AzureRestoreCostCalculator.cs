...
/// </list>
/// Plus internet egress on the bytes that leave Azure (download + rehydrated), beyond the free monthly allowance.
/// </summary>
internal static class AzureRestoreCostCalculator
{
    ...
    public static AzureRestoreCost Compute(RegionPricing pricing, RestoreCostRequest r)
    {
        ...
        var egressCost        = billableEgressGiB * pricing.EgressPerGb;
