...
CURRENCY = "EUR"  # Arius only supports EUR; this is the currencyCode the Retail Prices API is queried in.
...
def main():
    ...
    doc = {
        "_comment": (
            "Azure Blob Storage retail pricing — EUR (the only currency Arius supports), Standard "
            "general-purpose v2 block blobs, LRS "
