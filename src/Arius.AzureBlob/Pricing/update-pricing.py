...
sovereign regions are excluded (not deployable from a commercial subscription). A tier is omitted
where a region does not offer it (e.g. Belgium Central has no Archive tier).
...
def main():
    ...
    doc = {
        "_comment": (
            ...
            "(Government/MEC/sovereign clouds excluded). Azure bills per-GB values as binary GiB (2^30 "
