...
public class LocalFileEnumeratorTests : IDisposable
{
    ...
    public void Enumerate_BinaryWithPointer_ProducesFilePairWithBoth()
    {
        ...
        var pairs = _enumerator.Enumerate(_localRoot).ToList();
    ...
    public void Enumerate_PointerOnly_UsesLogicalBinaryRelativePath()
    {
        ...
        var pair = _enumerator.Enumerate(_localRoot).Single();
    ...
    public void Enumerate_MultipleFiles_AllAssembled()
    {
        ...
        pairs.Select(p => p.RelativePath).ShouldContain(RelativePath.Parse("photos/b.jpg"));
        pairs.Select(p => p.RelativePath).ShouldContain(RelativePath.Parse("photos/2024/c.jpg"));
    }
    ...
    {
        var result = FilePairEnumerator.NormalizePath(@"docs\2024\report.pdf");
    ...
    {
        var result = FilePairEnumerator.NormalizePath("photos/2024/june/a.jpg");
    ...
    {
        var result = FilePairEnumerator.NormalizePath("/photos/file.jpg");
    ...
    {
        var result = FilePairEnumerator.NormalizePath(@"a\b\c\d\e\f\g.txt");
    ...
    public void Enumerate_IsLazy_FirstElementAvailableBeforeAll()
    {
        ...
        foreach (var _ in _enumerator.Enumerate(_localRoot))
        {
            if (!firstYielded)
            {
