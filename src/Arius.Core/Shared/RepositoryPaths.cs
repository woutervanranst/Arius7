...
public static class RepositoryPaths
{
    ...
    public static LocalRootPath GetRepositoryDirectory(string accountName, string containerName)
    {
        ...
        return LocalRootPath.Parse(Path.Combine(home, ".arius", GetRepositoryDirectoryName(accountName, containerName)));

        static string GetRepositoryDirectoryName(string accountName, string containerName) => $"{accountName}-{containerName}";
    }
